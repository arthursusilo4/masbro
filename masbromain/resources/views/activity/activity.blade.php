...
<body class="bg-[#fff5f5] text-white min-h-screen">
    <div class="max-w-sm mx-auto min-h-screen">
        ...
        <div class="px-6 py-4">
            <h3 class="text-2xl font-bold mb-4 text-[#f32e24] text-center pt-3">ACTIV<span
                    class="text-[#f35124]">ITIES</span></h3>
            ...
            <form method="POST" action="{{ route('aktivitas.store') }}" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="flex items-center mb-2">
                    <label class="block text-lg font-medium text-[#f32e24]">Bra<span class="text-[#f35124]">nch</span></label>
                </div>
                ...
                <!-- Cluster -->
                <div class="flex items-center mb-2">
                    <label class="block text-lg font-medium text-[#f32e24]">Clus<span class="text-[#f35124]">ter</span></label>
                </div>
                @php
                ...
                <!-- Kota/Kabupaten -->
                <div class="flex items-center mb-2">
                    <label class="block text-lg font-medium text-[#f32e24]">Kota/<span class="text-[#f35124]">Kabupaten</span></label>
                ...
                <!-- Kecamatan -->
                <div class="flex items-center mb-2">
                    <label class="block text-lg font-medium text-[#f32e24]">Kecam<span class="text-[#f35124]">atan</span></label>
                    <span class="info-icon">i</span>
                    <span class="required-text">Wajib di pilih.</span>
                </div>
