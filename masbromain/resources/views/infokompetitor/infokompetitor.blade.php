    ...
    <div class="max-w-sm mx-auto min-h-screen">
        ...
        <div class="px-6 py-4">
            ...
            <form method="POST" action="{{ route('infokompetitor.store') }}" enctype="multipart/form-data"
                ...
                <!-- Channel -->
                <div class="flex items-center mb-2">
                    <label for="channel" class="block text-md font-medium text-[#f32e24]">Chan<span class="text-[#f35124]">nel</span></label>
                    <span class="info-icon">i</span>
                    <span class="required-text">Wajib di pilih.</span>
                </div>
                ...
                <div id="outletFields" class="hidden mt-3">
                    <div class="flex items-center mb-2">
                        <label for="idoutlet" class="block text-md font-medium text-[#f32e24]">ID <span class="text-[#f35124]">Outlet</span></label>
                        <span class="info-icon">i</span>
                    ...
                    <div class="flex items-center mb-2 mt-3">
                        <label for="namaoutlet" class="block text-md font-medium text-[#f32e24]">Nama <span class="text-[#f35124]">Outlet</span></label>
                        <span class="info-icon">i</span>
                        <span class="required-text">Wajib di isi.</span>
                    </div>
                ...
                <!-- Kompetitor (radio) -->
                <div class="flex items-center mb-2">
                    <label for="kompetitor" class="block text-md font-medium text-[#f32e24]">Kompe<span class="text-[#f35124]">titor</span></label>
                    <span class="info-icon">i</span>
                    <span class="required-text">Wajib di pilih.</span>
                </div>
                <div class="space-y-2">
