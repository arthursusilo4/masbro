        ...
        <div class="px-6 py-4">
            ...
            <form method="POST" action="{{ route('backcheck.store') }}" enctype="multipart/form-data"
               ...
               <!-- Branch -->
                ...
                <div class="flex items-center mb-2">
                    <label for="nomor owner" class="block text-md font-medium text-[#f32e24]">Nomor <span class="text-[#f35124]">Owner</span></label>
                    <span class="info-icon">i</span>
                    <span class="required-text">Wajib di isi.</span>
                </div>
                ...
                <div class="text-center">
                    <div class="flex items-center justify-center mb-2">
                        <label class="block text-md font-medium text-[#f32e24]">Foto <span class="text-[#f35124]">Laporan</span></label>
                        <span class="info-icon">i</span>
                        <span class="required-text">Wajib di isi.</span>
                    </div>
                ...
                <div class="text-center">
                    <div class="flex items-center justify-center mb-2">
                        <label class="block text-md font-medium text-[#f32e24]">
                ...
                <div class="text-center">
                    <div class="flex items-center justify-center mb-2">
                        <label class="block text-md font-medium text-[#f32e24]">Foto <span class="text-[#f35124]">Branding</span></label>
                        <span class="info-icon">i</span>
                        <span class="required-text">Wajib di isi.</span>
                    </div>
