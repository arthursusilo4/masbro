...
<body class="bg-[#fff5f5] text-white min-h-screen" style="font-family: 'Poppins', sans-serif;">
    <div class="max-w-sm mx-auto min-h-screen">
        ...
        <div class="px-6 py-4">
            ...
            <h2 class="text-xl font-bold text-[#f32e24] mb-4">Entry Detail</h2>
            ...
            <div class="max-w-lg mx-auto p-4">
                ...
                <form method="GET" class="space-y-4">
                    ...
                    <!-- Apply Button -->
                    <div>
                        <button type="submit" class="w-full bg-[#f32e24] text-white font-semibold rounded-lg p-2">Apply</button>
                    </div>
                </form>
        ...
        <div class="px-6 mb-20">
            <div class="pt-8 w-48 h-auto mx-auto bg-gray-200 rounded-lg p-4 text-center">
                <p class="text-gray-600">Jatim Grow Logo</p>
            </div>
        </div>
